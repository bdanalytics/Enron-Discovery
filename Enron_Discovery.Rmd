...
title: "2010 TREC Legal Track: Enron Discovery: responsive classification"
author: "bdanalytics"
...
Data: 
Source: 
    Training:   https://courses.edx.org/c4x/MITx/15.071x_2/asset/energy_bids.csv  
    New:        <newdt_url>  
Time period: 

```{r set_global_options_wd, echo=FALSE}
setwd("~/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Recitations/Unit5_Enron")
```
